                             ...
                             <div className="cardfahri-container">
                                <div className="cardfahri">
                                   <div className="cardfahri--display">
                                      ...
                                      <p>
                                         <span style={{ color: "skyblue" }}>Html</span>,<span style={{ color: "skyblue" }}> CSS</span>,<span style={{ color: "skyblue" }}> JavaScript</span>,<span style={{ color: "skyblue" }}> PHP</span>,
                                         using <span style={{ color: "skyblue" }}> jQuery</span>,<span style={{ color: "skyblue" }}> Ajax</span>,<span style={{ color: "skyblue" }}> Bootstrap </span>
                                         Framework{" "}
                                      </p>
                                   </div>
                                   <div className="project-link">
                             ...
                             <div className="cardfahri-container">
                                <div className="cardfahri">
                                   <div className="cardfahri--display">
                                      ...
                                      <p>
                                         <span style={{ color: "skyblue" }}>PHP</span>,<span style={{ color: "skyblue" }}> Html</span>,<span style={{ color: "skyblue" }}> CSS</span>,<span style={{ color: "skyblue" }}> JavaScript</span>,
                                         using <span style={{ color: "skyblue" }}> Bootstrap </span>
